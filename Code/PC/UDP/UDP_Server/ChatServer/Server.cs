...
namespace ChatServer
{
    public partial class Server : Form
    {
        ...
        {
            rtxtStatus.Text += DateTime.Now.ToString() + " " + status + Environment.NewLine;
        }
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                serverSocket.BeginSendTo(byteData, 0, byteData.Length, SocketFlags.None, client.endPoint, new AsyncCallback(this.SendData), null);
        ...
        private void timerTX_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                Packet sendData = new Packet();
                sendData.ChatName = ""; // this.name;
                sendData.ChatMessage = txtMessage.Text.Trim(); //"[" + itx.ToString() + "]" + DateTime.Now.ToString();
                itx++;
                sendData.ChatDataIdentifier = DataIdentifier.Message;
        ...
        {
            timerTX.Interval = Convert.ToInt16(textBoxTimer.Text);
